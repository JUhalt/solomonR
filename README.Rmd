...
OLS covariance this corresponds to the usual partial R-squared
identity. With robust covariance estimation it should be interpreted
as a descriptive Wald-based approximation.
