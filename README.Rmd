...
> targeting `v0.3.0`, which focuses on correct small-sample inference, input
> safeguards, and documentation for graduate students and applied
...
The current power-simulation helper is **experimental**, warns when it is
called, and should not be used for study planning. A redesigned and
...
[`ROADMAP.md`](ROADMAP.md), with committed v0.3 work tracked in the
[v0.3.0 milestone](https://github.com/JUhalt/solomonR/milestone/1) and
...
The current development source is licensed under the **GNU General Public
...
stable R-universe installation above continues to install that release until
a new release is published; changing the development license does not
relicense previously published versions.
