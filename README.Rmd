...
> graduate students and applied researchers. The API may continue to evolve
> before version 1.0. Development version `0.3.0.9000` is working toward
> `v0.4.0`: validated power and sample-size planning, and Solomon-specific
> figures.
...
[`ROADMAP.md`](ROADMAP.md), with committed v0.4 work tracked in the
[v0.4.0 milestone](https://github.com/JUhalt/solomonR/milestone/2) and
[GitHub issues](https://github.com/JUhalt/solomonR/issues).
