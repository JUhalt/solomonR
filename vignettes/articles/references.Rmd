...
> categorical outcomes. *In solomonR:* the historical categorical path for
> binary outcomes (planned,
> [#43](https://github.com/JUhalt/solomonR/issues/43)).
...
> binary-outcome example (planned,
> [#43](https://github.com/JUhalt/solomonR/issues/43)).
