...
- **Limitations:** its point estimates coincide with separate regressions
  in the two pretest conditions. Its Wald intervals use a normal
  reference distribution and can be too narrow in small samples;
  simulation validation is tracked in issue #10.
